...
public interface UserRepository extends JpaRepository<User, Long> {
     ...
     */
    @Modifying
    @Query(value = "INSERT INTO public.user_event (user_email, event_id, is_sent) VALUES (?1, ?2, false)", nativeQuery = true)
     ...
     */
    @Modifying
    @Query(value = "DELETE FROM public.user_event WHERE user_email = ?1 AND event_id = ?2", nativeQuery = true)
